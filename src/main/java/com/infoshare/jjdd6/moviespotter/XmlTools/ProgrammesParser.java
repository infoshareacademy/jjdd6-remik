...
//    private Channel channel;
    ...
    //    public void doParse(Document doc, ProgrammeDao programmeDao, ChannelDao channelDao) {
    public void doParse(Document doc) {
        ...
        for (int i = 0; i < programmesList.getLength(); i++) {
            ...
            if (channelDao.findByName(channelName).isEmpty() || channelDao.findByName(channelName) == null) {
                channel.setName(channelName);
